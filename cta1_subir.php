...
include ($_SERVER['DOCUMENT_ROOT']."/1contraloria/upload_class.php"); //classes is the map where the class file is stored (one above the root)

$max_size = 1024*250; // the max. size for uploading

$my_upload = new file_upload;

$my_upload->upload_dir = $_SERVER['DOCUMENT_ROOT']."/1contraloria/archs/"; // "files" is thefolder for the uploaded files (you have to create this folder)
