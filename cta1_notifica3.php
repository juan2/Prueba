...
<?php
	...
	$statement = "ctra1_pras where eliminado=0 and (date(fecha_cambio_estatus) BETWEEN '".$fecha_ini."' and '".$fecha_fin."') $filtroxsecre_pag ";
...
#	$result99.=" LEFT JOIN ctra1_catalogos ct3 ON ct3.id_unico=pr.id_mpio ";
	...
	$result99.=" WHERE pr.eliminado=0 and (date(pr.fecha_cambio_estatus) BETWEEN '".$fecha_ini."' and '".$fecha_fin."') $filtroxsecre ";
	$result99.=" ORDER BY pr.fecha_cambio_estatus LIMIT {$startpoint} , {$limit} ";
...
<h3>Últimos Cambios Status &nbsp;&nbsp;&nbsp;<i class="icon-asterisk"></i><?php echo $total_reg.' de '.$total_general; ?> registro(s)</h3>
	...
	<div class="accordion-group">
	  ...
	  <div id="collapseOne" class="accordion-body collapse">
		<div class="accordion-inner">
			...
			<div class="span5">
			<form class="form-inline" id="frmCaptura" name="frmCaptura" method="POST" action="cta1_notifica3.php">
			<div class="row-fluid">
			<div class="span3">
				<fieldset>
